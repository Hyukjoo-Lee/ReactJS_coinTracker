      ...
      {tickersLoading ? (
        ...
        <Overviews>
          ...
          <OverviewItem>
            ...
            <Percentage
              isPositive={
                checkGrowth(tickersData?.quotes.USD.percent_change_24h) === true
              }
            >
          ...
          <OverviewItem>
            ...
            <Percentage
              isPositive={
                checkGrowth(tickersData?.quotes.USD.percent_change_15m) === true
              }
            >
          ...
          <OverviewItem>
            ...
            <Percentage
              isPositive={
                checkGrowth(tickersData?.quotes.USD.percent_change_30m) === true
              }
            >
          ...
          <OverviewItem>
            ...
            <Percentage
              isPositive={
                checkGrowth(tickersData?.quotes.USD.percent_change_1h) === true
              }
            >
